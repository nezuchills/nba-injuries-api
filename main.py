...
def balldontlie_raw(cursor: Optional[int] = None, per_page: int = 25) -> Dict[str, Any]:
    """
    Renvoie les données brutes de BallDontLie pour les blessures.
    - Paginate avec cursor / per_page.
    - Pas encore filtré par joueur.
    """
    ...
    url = "https://api.balldontlie.io/v1/player_injuries"
    headers = {"Authorization": api_key}  # cf. docs BallDontLie [web:101][web:30]
    ...
    # On renvoie tel quel pour le moment (data + meta) [web:101]
    return {
        "source": "balldontlie",
        "endpoint": url,
        "params": params,
